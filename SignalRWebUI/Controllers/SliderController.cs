...
namespace SignalRWebUI.Controllers
{
	public class SliderController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:7087/api/Slider");
		...
		public async Task<IActionResult> CreateSlider(CreateSliderDto createSliderDto)
		{
			...
			var responseMessage = await client.PostAsync("https://localhost:7087/api/Slider", stringContent);
			if (responseMessage.IsSuccessStatusCode)
			{
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.DeleteAsync($"https://localhost:7087/api/Slider/{id}");
			if (responseMessage.IsSuccessStatusCode)
			{
				return RedirectToAction("Index");
			}
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.GetAsync($"https://localhost:7087/api/Slider/{id}");
